...
const theme = themeFunction();
 ...
 function InsurAIClaimsView({ claimsData, setClickedCard }) {
  ...
  const handleDownload = (format) => {
    ...
    if (format === "csv") {
      ...
      csvLink.download = "Ivan-claims-data.csv";
      csvLink.click();
    } else if (format === "pdf") {
      const doc = new jsPDF('landscape');
      const filename = "Ivan_claims_report";
      ...
      addDateToPDF(doc, 28);
      doc.setFontSize(12);
      doc.text(`This report provides a detailed list of IVAN claims.`, 14, 40);
      ...
      XLSX.utils.book_append_sheet(workbook, worksheet, "Ivan Claims Data");
      XLSX.writeFile(workbook, "Ivan-claims-data.xlsx");
    }
  };
        ...
        <VuiBox py={3}>
          <Card>
                ...
                <List sx={{ py: 0 }}>
                  <ListItem alignItems="center" disableGutters sx={{ py: 0 }}>
                    ...
                    <ListItemText
                      ...
                      primary={<Typography variant="h6">IVAN (Innovon Virtual Assistant) Claims Information</Typography>}
                    />
                  </ListItem>
                </List>
              </MDTypography>
            ...
            <MDBox pt={3} px={3} py={3}>                   
              <MDTypography sx={{fontSize:"1rem"}}><InfoOutlinedIcon sx={{mr: 1, color:"#5e35b1"}} fontSize="inherit"/>No Claims found.</MDTypography>
            </MDBox>        
              </Card>
        </VuiBox>
      </MDBox>
