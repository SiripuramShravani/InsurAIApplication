...
import error from '../../assets/connectionTimedout.png';
  ...
  return (
    ...
    >
      ...
      >
        ...
        <img
          src={error}
          alt="Connection Timed Out" // Accessibility description
          style={{ width: '300px', marginBottom: '20px' }} // Adjusted width of the error image
        />
        <Typography 
          sx={{
            textAlign: 'center',
